...
C:\LLVM\bin\clang++ *.cpp \Eric\Main\WinApi\*.cpp \Eric\Main\CppBase\*.cpp \Eric\Main\CppMem\*.cpp -o ainewscpp.exe -Weverything -Wno-c++98-compat-pedantic -ftrapv -Ofast -Wl,-MAP -Wl,-STACK:10000000 2> Build.log
